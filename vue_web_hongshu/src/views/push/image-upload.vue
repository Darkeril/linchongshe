    ...
    <template v-else>
      <div class="header">
        <div class="header-left">
          ...
          <span class="header-title">{{ $t("note.publishImageText") }}</span>
  ...
  (newFiles, oldFiles) => {
    ...
    oldFiles?.forEach((file) => {
      if (
        ...
        !newFiles.some((newFile) => newFile.url === file.url || newFile.uid === file.uid)
      ) {
  ...
  .cover-selector {
    ...
    .cover-option {
      ...
      &.active {
        ...
        .cover-mask {
          opacity: 1;
          background: rgba(51, 158, 230, 0.3);
        }
      }
    }
  }
