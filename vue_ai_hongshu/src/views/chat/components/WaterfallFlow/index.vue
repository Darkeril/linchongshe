<template>
    <div ref="waterRef" class="overflow-hidden overflow-y-auto waterfall-container no-scrollbar">
        <div class="waterfall-item bg-sky-50 hover:bg-sky-100 dark:bg-[#24272e] hover:dark:bg-[#18181c] rounded-md cursor-pointer "
            ...
            <div class="item-info" :style="{ width: defaultOptions.waterfallWidth + 'px' }">
                <div class="font-medium item-content">{{ parseEmoji(item.icon) }} {{ item.title }}</div>
                <div class="mb-1 text-xs leading-5 item-content">{{ item.description }}</div>
                <div class="px-2.5 flex justify-between items-center">
                    ...
                    <div class="flex items-center justify-center w-6 h-6 hover:bg-white hover:text-blue-600 hover:rounded-md"
