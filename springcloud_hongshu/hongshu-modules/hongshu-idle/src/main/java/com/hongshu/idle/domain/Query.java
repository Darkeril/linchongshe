...
import com.hongshu.idle.xss.SQLFilter;
import lombok.Data;
...
public class Query extends LinkedHashMap<String, Object> implements Serializable {
    ...
    private String commentType;  // note 或 product
    ...
    public void putAllPar(Map<String, Object> params) {
        ...
        this.hsId = ValidatorUtil.isNotNull(params.get("hsId")) ? Long.valueOf(params.get("hsId").toString()) : null;
        this.uid = ValidatorUtil.isNotNull(params.get("uid")) ? Long.valueOf(params.get("uid").toString()) : null;
        this.title = ValidatorUtil.isNotNull(params.get("title")) ? String.valueOf(params.get("title").toString()) : null;
        ...
        this.username = BaseAssert.getParamOrElse(params, "username");
        this.operater = BaseAssert.getParamOrElse(params, "operater");
        this.phone = BaseAssert.getParamOrElse(params, "phone");
        this.status = ValidatorUtil.isNotNull(params.get("status")) ? Integer.valueOf(params.get("status").toString()) : null;
        this.noteType = ValidatorUtil.isNotNull(params.get("noteType")) ? Integer.valueOf(params.get("noteType").toString()) : null;
        this.commentType = BaseAssert.getParamOrElse(params, "commentType");
