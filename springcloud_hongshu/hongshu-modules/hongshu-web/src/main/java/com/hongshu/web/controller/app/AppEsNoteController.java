...
public class AppEsNoteController {
     ...
     */
    @NoLoginIntercept
    @GetMapping("getVideoNote/{currentPage}/{pageSize}")
    public Result<?> getVideoNote(@PathVariable long currentPage, @PathVariable long pageSize) {
        Page<NoteSearchVo> page = esNoteService.getVideoNote(currentPage, pageSize);
        return Result.ok(page);
    }
    ...
    @GetMapping("/getNotesNearBy/{currentPage}/{pageSize}")
    public Result<?> getNotesNearBy(@PathVariable long currentPage, @PathVariable long pageSize) {
        Page<NoteSearchVo> page = esNoteService.getNotesNearBy(currentPage, pageSize);
        return Result.ok(page);
    }
