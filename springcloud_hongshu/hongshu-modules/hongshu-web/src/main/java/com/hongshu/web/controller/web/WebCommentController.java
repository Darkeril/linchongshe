...
public class WebCommentController {
     ...
     */
    @GetMapping("getCommentWithCommentByProductId/{currentPage}/{pageSize}")
    public Result<?> getCommentWithCommentByProductId(@PathVariable long currentPage, @PathVariable long pageSize, String productId) {
        Page<CommentVo> pageInfo = commentService.getCommentWithCommentByProductId(currentPage, pageSize, productId);
        return Result.ok(pageInfo);
    }
