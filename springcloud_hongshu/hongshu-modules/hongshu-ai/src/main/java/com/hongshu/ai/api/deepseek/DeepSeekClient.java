package com.hongshu.ai.api.deepseek;
...
import com.hongshu.ai.api.deepseek.constant.DeepSeekConst;
import com.hongshu.ai.api.deepseek.sse.DefaultPluginListener;
import com.hongshu.ai.api.deepseek.sse.PluginListener;
import com.hongshu.ai.api.openai.OpenAiApi;
import com.hongshu.ai.api.openai.constant.OpenAIConst;
import com.hongshu.ai.api.openai.entity.Tts.TextToSpeech;
import com.hongshu.ai.api.openai.entity.assistant.message.MessageFileResponse;
import com.hongshu.ai.api.openai.entity.assistant.message.MessageResponse;
import com.hongshu.ai.api.openai.entity.assistant.message.ModifyMessage;
import com.hongshu.ai.api.openai.entity.assistant.thread.ModifyThread;
import com.hongshu.ai.api.openai.entity.assistant.thread.ThreadMessage;
import com.hongshu.ai.api.openai.entity.assistant.thread.ThreadResponse;
import com.hongshu.ai.api.openai.entity.billing.BillingUsage;
import com.hongshu.ai.api.openai.entity.billing.CreditGrantsResponse;
import com.hongshu.ai.api.openai.entity.billing.Subscription;
import com.hongshu.ai.api.openai.entity.chat.*;
import com.hongshu.ai.api.openai.entity.common.DeleteResponse;
import com.hongshu.ai.api.openai.entity.common.OpenAiResponse;
import com.hongshu.ai.api.openai.entity.common.PageRequest;
import com.hongshu.ai.api.openai.entity.completions.Completion;
import com.hongshu.ai.api.openai.entity.completions.CompletionResponse;
import com.hongshu.ai.api.openai.entity.edits.Edit;
import com.hongshu.ai.api.openai.entity.edits.EditResponse;
import com.hongshu.ai.api.openai.entity.embeddings.Embedding;
import com.hongshu.ai.api.openai.entity.embeddings.EmbeddingResponse;
import com.hongshu.ai.api.openai.entity.engines.Engine;
import com.hongshu.ai.api.openai.entity.files.File;
import com.hongshu.ai.api.openai.entity.files.UploadFileResponse;
import com.hongshu.ai.api.openai.entity.fineTune.Event;
import com.hongshu.ai.api.openai.entity.fineTune.FineTune;
import com.hongshu.ai.api.openai.entity.fineTune.FineTuneDeleteResponse;
import com.hongshu.ai.api.openai.entity.fineTune.FineTuneResponse;
import com.hongshu.ai.api.openai.entity.fineTune.job.FineTuneJob;
import com.hongshu.ai.api.openai.entity.fineTune.job.FineTuneJobEvent;
import com.hongshu.ai.api.openai.entity.fineTune.job.FineTuneJobListResponse;
import com.hongshu.ai.api.openai.entity.fineTune.job.FineTuneJobResponse;
import com.hongshu.ai.api.openai.entity.images.Image;
import com.hongshu.ai.api.openai.entity.images.ImageResponse;
import com.hongshu.ai.api.openai.entity.images.Item;
import com.hongshu.ai.api.openai.entity.models.Model;
import com.hongshu.ai.api.openai.entity.models.ModelResponse;
import com.hongshu.ai.api.openai.entity.moderations.Moderation;
import com.hongshu.ai.api.openai.entity.moderations.ModerationResponse;
import com.hongshu.ai.api.openai.entity.whisper.Transcriptions;
import com.hongshu.ai.api.openai.entity.whisper.Translations;
import com.hongshu.ai.api.openai.entity.whisper.WhisperResponse;
import com.hongshu.ai.api.openai.exception.BaseException;
import com.hongshu.ai.api.openai.exception.CommonError;
import com.hongshu.ai.api.openai.function.KeyRandomStrategy;
import com.hongshu.ai.api.openai.function.KeyStrategyFunction;
import com.hongshu.ai.api.openai.interceptor.DefaultOpenAiAuthInterceptor;
import com.hongshu.ai.api.openai.interceptor.DynamicKeyOpenAiAuthInterceptor;
import com.hongshu.ai.api.openai.interceptor.OpenAILogger;
import com.hongshu.ai.api.openai.interceptor.OpenAiAuthInterceptor;
import com.hongshu.ai.api.openai.plugin.PluginAbstract;
import com.hongshu.ai.api.openai.plugin.PluginParam;
import com.hongshu.ai.api.openai.utils.SSEUtil;
 ...
 */
@Slf4j
public class DeepSeekClient implements KeyUpdater {
    /**
     * keys
     */
    @Getter
    ...
    public List<Item> editImages(java.io.File image, String prompt) {
        com.hongshu.ai.api.openai.entity.images.ImageEdit imageEdit = com.hongshu.ai.api.openai.entity.images.ImageEdit.builder().prompt(prompt).build();
     ...
     * @return Item  list
     */
    public List<Item> editImages(java.io.File image, com.hongshu.ai.api.openai.entity.images.ImageEdit imageEdit) {
        return this.editImages(image, null, imageEdit);
    }
     ...
     * @return Item list
     */
    public List<Item> editImages(java.io.File image, java.io.File mask, com.hongshu.ai.api.openai.entity.images.ImageEdit imageEdit) {
        checkImage(image);
     ...
     * @return ImageResponse
     */
    public ImageResponse variationsImages(java.io.File image, com.hongshu.ai.api.openai.entity.images.ImageVariations imageVariations) {
        checkImage(image);
        checkImageFormat(image);
        checkImageSize(image);
        RequestBody imageBody = RequestBody.create(MediaType.parse("multipart/form-data"), image);
    ...
    public ImageResponse variationsImages(java.io.File image) {
        ...
        checkImageFormat(image);
        checkImageSize(image);
        com.hongshu.ai.api.openai.entity.images.ImageVariations imageVariations = com.hongshu.ai.api.openai.entity.images.ImageVariations.builder().build();
...
//    }
     ...
     * @return 答案
     */
    public <T extends com.hongshu.ai.api.openai.entity.chat.BaseChatCompletion> com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse chatCompletion(T chatCompletion) {
        if (chatCompletion instanceof ChatCompletion) {
            Single<com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse> chatCompletionResponse = this.openAiApi.chatCompletion((ChatCompletion) chatCompletion);
            return chatCompletionResponse.blockingGet();
        }
        Single<com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse> chatCompletionResponse = this.openAiApi.chatCompletionWithPicture((com.hongshu.ai.api.openai.entity.chat.ChatCompletionWithPicture) chatCompletion);
        return chatCompletionResponse.blockingGet();
    }
     ...
     * @return 答案
     */
    public com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse chatCompletion(List<Message> messages) {
     ...
     */
    public <R extends PluginParam, T> com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse chatCompletionWithPlugin(ChatCompletion chatCompletion, PluginAbstract<R, T> plugin) {
        ...
        com.hongshu.ai.api.openai.entity.chat.Functions functions = com.hongshu.ai.api.openai.entity.chat.Functions.builder()
        ...
        //调用OpenAi
        com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse functionCallChatCompletionResponse = this.chatCompletion(chatCompletion);
        ...
        com.hongshu.ai.api.openai.entity.chat.FunctionCall functionCall = com.hongshu.ai.api.openai.entity.chat.FunctionCall.builder()
        ...
        com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse chatCompletionResponse = this.chatCompletion(chatCompletion);
     ...
     * @return ChatCompletionResponse
     */
    public <R extends PluginParam, T> com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse chatCompletionWithPlugin(List<Message> messages, PluginAbstract<R, T> plugin) {
     ...
     * @return ChatCompletionResponse
     */
    public <R extends PluginParam, T> com.hongshu.ai.api.openai.entity.chat.ChatCompletionResponse chatCompletionWithPlugin(List<Message> messages, String model, PluginAbstract<R, T> plugin) {
     ...
     * @since 1.1.2
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantResponse assistant(com.hongshu.ai.api.openai.entity.assistant.Assistant assistant) {
        Single<com.hongshu.ai.api.openai.entity.assistant.AssistantResponse> assistantResponse = this.openAiApi.assistant(assistant);
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantResponse retrieveAssistant(String assistantId) {
        Single<com.hongshu.ai.api.openai.entity.assistant.AssistantResponse> assistant = this.openAiApi.retrieveAssistant(assistantId);
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantResponse modifyAssistant(String assistantId, com.hongshu.ai.api.openai.entity.assistant.Assistant assistant) {
        Single<com.hongshu.ai.api.openai.entity.assistant.AssistantResponse> assistantResponse = this.openAiApi.modifyAssistant(assistantId, assistant);
        return assistantResponse.blockingGet();
    }
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<com.hongshu.ai.api.openai.entity.assistant.AssistantResponse> assistants(PageRequest pageRequest) {
        Single<com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<com.hongshu.ai.api.openai.entity.assistant.AssistantResponse>> assistants = this.openAiApi.assistants(pageRequest.getLimit(), pageRequest.getOrder(), pageRequest.getBefore(), pageRequest.getAfter());
     ...
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantFileResponse assistantFile(String assistantId, com.hongshu.ai.api.openai.entity.assistant.AssistantFile assistantFile) {
        Single<com.hongshu.ai.api.openai.entity.assistant.AssistantFileResponse> assistantFileResponse = this.openAiApi.assistantFile(assistantId, assistantFile);
     ...
     * @return 助手文件信息
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantFileResponse retrieveAssistantFile(String assistantId, String fileId) {
        Single<com.hongshu.ai.api.openai.entity.assistant.AssistantFileResponse> assistantFileResponse = this.openAiApi.retrieveAssistantFile(assistantId, fileId);
        return assistantFileResponse.blockingGet();
    }
     ...
     * @return 助手文件列表
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<com.hongshu.ai.api.openai.entity.assistant.AssistantFileResponse> assistantFiles(String assistantId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
        Single<com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<com.hongshu.ai.api.openai.entity.assistant.AssistantFileResponse>> deleteResponse = this.openAiApi.assistantFiles(assistantId, pageRequest.getLimit(), pageRequest.getOrder(), pageRequest.getBefore(), pageRequest.getAfter());
        return deleteResponse.blockingGet();
    }
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<MessageResponse> messages(String threadId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<MessageFileResponse> messageFiles(String threadId, String messageId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.run.RunResponse run(String threadId, com.hongshu.ai.api.openai.entity.assistant.run.Run run) {
     ...
     * @since 1.1.6
     */
    public void runWithStream(String threadId, com.hongshu.ai.api.openai.entity.assistant.run.Run run, EventSourceListener eventSourceListener) {
        if (!run.isStream()) {
            run.setStream(true);
        }
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.run.RunResponse retrieveRun(String threadId, String runId) {
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.run.RunResponse modifyRun(String threadId, String runId, com.hongshu.ai.api.openai.entity.assistant.run.ModifyRun run) {
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<com.hongshu.ai.api.openai.entity.assistant.run.RunResponse> runs(String threadId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.run.RunResponse submitToolOutputs(String threadId, String runId, com.hongshu.ai.api.openai.entity.assistant.run.ToolOutputBody toolOutputs) {
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.run.RunResponse cancelRun(String threadId, String runId) {
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.run.RunResponse threadRun(com.hongshu.ai.api.openai.entity.assistant.run.ThreadRun threadRun) {
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.run.RunStepResponse retrieveRunStep(String threadId, String runId, String stepId) {
     ...
     * @since 1.1.3
     */
    public com.hongshu.ai.api.openai.entity.assistant.AssistantListResponse<com.hongshu.ai.api.openai.entity.assistant.run.RunStepResponse> runSteps(String threadId, String runId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
    ...
    public void streamCompletions(Completion completion, EventSourceListener eventSourceListener) {
        if (Objects.isNull(eventSourceListener)) {
            log.error("参数异常：EventSourceListener不能为空，可以参考：com.hongshu.chat.api.openai.sse.ConsoleEventSourceListener");
            throw new BaseException(CommonError.PARAM_ERROR);
        }
