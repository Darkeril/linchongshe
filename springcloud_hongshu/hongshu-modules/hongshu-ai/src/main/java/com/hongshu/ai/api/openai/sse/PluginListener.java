...
import com.hongshu.ai.api.openai.entity.chat.FunctionCall;
...
public abstract class PluginListener<R extends PluginParam, T> extends EventSourceListener {
     ...
     */
    public PluginListener(OpenAiClient client, EventSourceListener eventSourceListener, PluginAbstract<R, T> plugin, ChatCompletion chatCompletion) {
        this.client = client;
