...
import com.hongshu.common.core.exception.file.FileNameLengthLimitExceededException;
import com.hongshu.common.core.exception.file.FileSizeLimitExceededException;
import com.hongshu.common.core.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = HongshuConfig.getProfile();
    ...
    public static final String upload(String baseDir, File file, String[] allowedExtension)
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException,
            InvalidExtensionException {
        // 校验文件名长度
    ...
    public static final String extractFilename(File file) {
        ...
        return StringUtils.format("{}/{}_{}.{}", DateUtils.datePath(),
                baseName, Seq.getId(Seq.uploadSeqType), extension);
    }
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = HongshuConfig.getProfile().length() + 1;
    ...
    public static final String getExtension(String fileName) {
        ...
        // 本地文件一般不会缺少扩展名，这里无需再用 contentType 判断
        return extension;
    }
}
