...
public class FileUtilss {
    ...
    public static String markdownToHtml(String markdown) {
        MutableDataSet options = new MutableDataSet().set(Parser.EXTENSIONS, Arrays.asList(AutolinkExtension.create(), EmojiExtension.create(), StrikethroughExtension.create(), TaskListExtension.create(), TablesExtension.create()))
                ...
                .set(EmojiExtension.USE_SHORTCUT_TYPE, EmojiShortcutType.GITHUB).set(EmojiExtension.USE_IMAGE_TYPE, EmojiImageType.IMAGE_ONLY)
                // other options
                ;
    ...
    public static String uploadFile(String pathRoot, String baseUrl, MultipartFile avatar) throws IllegalStateException, IOException {
        ...
        if (!avatar.isEmpty()) {
            ...
            if (contentType.indexOf("image") != -1) {
                ...
                path = baseUrl + StringUtilss.getUUID() + "." + imageName;
    ...
    public static String getFileName(String originalFilename) {
        String fileName = "";
        if (StringUtils.isNotBlank(originalFilename) && StringUtils.contains(originalFilename, ".")) {
    ...
    public static final String[] IMG_FILE = {Constantss.FILE_SUFFIX_BMP, Constantss.FILE_SUFFIX_JPG, Constantss.FILE_SUFFIX_PNG, Constantss.FILE_SUFFIX_TIF, Constantss.FILE_SUFFIX_GIF, Constantss.FILE_SUFFIX_JPEG, Constantss.FILE_SUFFIX_WEBP};
    public static final String[] DOC_FILE = {Constantss.FILE_SUFFIX_DOC, Constantss.FILE_SUFFIX_DOCX, Constantss.FILE_SUFFIX_TXT, Constantss.FILE_SUFFIX_HLP, Constantss.FILE_SUFFIX_WPS, Constantss.FILE_SUFFIX_RTF, Constantss.FILE_SUFFIX_XLS, Constantss.FILE_SUFFIX_XLSX, Constantss.FILE_SUFFIX_PPT, Constantss.FILE_SUFFIX_PPTX, Constantss.FILE_SUFFIX_JAVA, Constantss.FILE_SUFFIX_HTML, Constantss.FILE_SUFFIX_PDF, Constantss.FILE_SUFFIX_MD, Constantss.FILE_SUFFIX_SQL, Constantss.FILE_SUFFIX_CSS, Constantss.FILE_SUFFIX_JS, Constantss.FILE_SUFFIX_VUE, Constantss.FILE_SUFFIX_JAVA};
    public static final String[] VIDEO_FILE = {Constantss.FILE_SUFFIX_AVI, Constantss.FILE_SUFFIX_MP4, Constantss.FILE_SUFFIX_MPG, Constantss.FILE_SUFFIX_MOV, Constantss.FILE_SUFFIX_SWF, Constantss.FILE_SUFFIX_3GP, Constantss.FILE_SUFFIX_RM, Constantss.FILE_SUFFIX_RMVB, Constantss.FILE_SUFFIX_WMV, Constantss.FILE_SUFFIX_MKV};
    public static final String[] MUSIC_FILE = {Constantss.FILE_SUFFIX_WAV, Constantss.FILE_SUFFIX_AIF, Constantss.FILE_SUFFIX_AU, Constantss.FILE_SUFFIX_MP3, Constantss.FILE_SUFFIX_RAM, Constantss.FILE_SUFFIX_WMA, Constantss.FILE_SUFFIX_MMF, Constantss.FILE_SUFFIX_AMR, Constantss.FILE_SUFFIX_AAC, Constantss.FILE_SUFFIX_FLAC};
    public static String[] ALL_FILE = {Constantss.FILE_SUFFIX_BMP, Constantss.FILE_SUFFIX_JPG, Constantss.FILE_SUFFIX_PNG, Constantss.FILE_SUFFIX_TIF, Constantss.FILE_SUFFIX_GIF, Constantss.FILE_SUFFIX_JPEG, Constantss.FILE_SUFFIX_WEBP,

            Constantss.FILE_SUFFIX_DOC, Constantss.FILE_SUFFIX_DOCX, Constantss.FILE_SUFFIX_TXT, Constantss.FILE_SUFFIX_HLP, Constantss.FILE_SUFFIX_WPS, Constantss.FILE_SUFFIX_RTF, Constantss.FILE_SUFFIX_XLS, Constantss.FILE_SUFFIX_XLSX, Constantss.FILE_SUFFIX_PPT, Constantss.FILE_SUFFIX_PPTX, Constantss.FILE_SUFFIX_JAVA, Constantss.FILE_SUFFIX_HTML, Constantss.FILE_SUFFIX_PDF, Constantss.FILE_SUFFIX_MD, Constantss.FILE_SUFFIX_SQL, Constantss.FILE_SUFFIX_CSS, Constantss.FILE_SUFFIX_JS, Constantss.FILE_SUFFIX_VUE, Constantss.FILE_SUFFIX_JAVA,

            Constantss.FILE_SUFFIX_AVI, Constantss.FILE_SUFFIX_MP4, Constantss.FILE_SUFFIX_MPG, Constantss.FILE_SUFFIX_MOV, Constantss.FILE_SUFFIX_SWF, Constantss.FILE_SUFFIX_3GP, Constantss.FILE_SUFFIX_RM, Constantss.FILE_SUFFIX_RMVB, Constantss.FILE_SUFFIX_WMV, Constantss.FILE_SUFFIX_MKV,

            Constantss.FILE_SUFFIX_WAV, Constantss.FILE_SUFFIX_AIF, Constantss.FILE_SUFFIX_AU, Constantss.FILE_SUFFIX_MP3, Constantss.FILE_SUFFIX_RAM, Constantss.FILE_SUFFIX_WMA, Constantss.FILE_SUFFIX_MMF, Constantss.FILE_SUFFIX_AMR, Constantss.FILE_SUFFIX_AAC, Constantss.FILE_SUFFIX_FLAC};
...
//    }
    ...
    public static String getFileSuffix(String filename) {
        String suffix;
        suffix = filename.substring(filename.lastIndexOf(Constantss.SYMBOL_POINT) + 1);
        return suffix;
    }
