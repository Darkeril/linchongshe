package com.hongshu.common.core.global;
...
public final class SysConf extends BaseSysConf {
    ...
    public final static String GOODS_CONTRIBUTE_COUNT = "goodsContributeCount";
    ...
    public final static String PRODUCT_COUNT = "productCount";
    public final static String GPT_MODEL_COUNT = "gptModelCount";
