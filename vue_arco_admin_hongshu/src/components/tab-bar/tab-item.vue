<template>
  ...
  >
    ...
    >
      <span class="tag-link">
        {{ itemData.locale && $te(itemData.locale) ? $t(itemData.locale) : itemData.title }}
      </span>
      <span
    ...
    <template #content>
      ...
      >
        <icon-close />
        <span>{{ $t('common.closeCurrent') }}</span>
      </a-doption>
      <a-doption :disabled="disabledLeft" :value="Eaction.left">
        <icon-to-left />
        <span>{{ $t('common.closeLeft') }}</span>
      </a-doption>
      <a-doption
        class="sperate-line"
