...
// 通用分页结果提取：兼容 data.records / data.rows / data.list / data(array)
// revert: remove extractPage helper
...
/**
 * Returns the BCP-47 locale tag matching the user's current language preference.
 * Falls back to 'zh-CN' when nothing is stored.
 */
